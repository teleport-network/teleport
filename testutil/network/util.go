...
func collectGenFiles(cfg Config, vals []*Validator, outputDir string) error {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		nodeDir := filepath.Join(outputDir, vals[i].Moniker, "bitchain")
		...
		appState, err := genutil.GenAppStateFromConfig(cfg.Codec, cfg.TxConfig, tmCfg, initCfg, *genDoc, banktypes.GenesisBalancesIterator{})
		if err != nil {
			return err
		}
...
func initGenFiles(cfg Config, genAccounts []authtypes.GenesisAccount, genBalances []banktypes.Balance, genFiles []string) error {
	...
	slashingGenState.Params.SignedBlocksWindow = int64(cfg.SignedBlocksWindow)
