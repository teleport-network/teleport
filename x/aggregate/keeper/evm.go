...
// DeployERC20Contract creates and deploys an ERC20 contract on the EVM with the aggregate module account as owner.
	...
	*evmtypes.MsgEthereumTxResponse, error,
	...
	if err != nil {
		return nil, sdkerrors.Wrap(
			types.ErrABIPack, sdkerrors.Wrap(err, "failed to create transaction data").Error(),
		)
	}
