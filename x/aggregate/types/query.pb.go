...
// source: teleport/aggregate/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryTokenPairsRequest)(nil), "teleport.aggregate.v1.QueryTokenPairsRequest")
	proto.RegisterType((*QueryTokenPairsResponse)(nil), "teleport.aggregate.v1.QueryTokenPairsResponse")
	proto.RegisterType((*QueryTokenPairRequest)(nil), "teleport.aggregate.v1.QueryTokenPairRequest")
	proto.RegisterType((*QueryTokenPairResponse)(nil), "teleport.aggregate.v1.QueryTokenPairResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "teleport.aggregate.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "teleport.aggregate.v1.QueryParamsResponse")
}

func init() { proto.RegisterFile("teleport/aggregate/v1/query.proto", fileDescriptor_bfecb508a10d5fb7) }
...
func (c *queryClient) TokenPairs(ctx context.Context, in *QueryTokenPairsRequest, opts ...grpc.CallOption) (*QueryTokenPairsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/teleport.aggregate.v1.Query/TokenPairs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TokenPair(ctx context.Context, in *QueryTokenPairRequest, opts ...grpc.CallOption) (*QueryTokenPairResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/teleport.aggregate.v1.Query/TokenPair", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/teleport.aggregate.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_TokenPairs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/teleport.aggregate.v1.Query/TokenPairs",
	}
...
func _Query_TokenPair_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/teleport.aggregate.v1.Query/TokenPair",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/teleport.aggregate.v1.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "teleport.aggregate.v1.Query",
	...
	Metadata: "teleport/aggregate/v1/query.proto",
}
