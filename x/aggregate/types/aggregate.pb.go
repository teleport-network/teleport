...
// source: bitchain/aggregate/v1/aggregate.proto
...
type TokenPair struct {
	...
	ContractOwner Owner `protobuf:"varint,4,opt,name=contract_owner,json=contractOwner,proto3,enum=bitchain.aggregate.v1.Owner" json:"contract_owner,omitempty"`
}
...
func init() {
	proto.RegisterEnum("bitchain.aggregate.v1.Owner", Owner_name, Owner_value)
	proto.RegisterType((*TokenPair)(nil), "bitchain.aggregate.v1.TokenPair")
	proto.RegisterType((*RegisterCoinProposal)(nil), "bitchain.aggregate.v1.RegisterCoinProposal")
	proto.RegisterType((*AddCoinProposal)(nil), "bitchain.aggregate.v1.AddCoinProposal")
	proto.RegisterType((*RegisterERC20Proposal)(nil), "bitchain.aggregate.v1.RegisterERC20Proposal")
	proto.RegisterType((*ToggleTokenRelayProposal)(nil), "bitchain.aggregate.v1.ToggleTokenRelayProposal")
	proto.RegisterType((*UpdateTokenPairERC20Proposal)(nil), "bitchain.aggregate.v1.UpdateTokenPairERC20Proposal")
	proto.RegisterType((*RegisterERC20TraceProposal)(nil), "bitchain.aggregate.v1.RegisterERC20TraceProposal")
	proto.RegisterType((*EnableTimeBasedSupplyLimitProposal)(nil), "bitchain.aggregate.v1.EnableTimeBasedSupplyLimitProposal")
	proto.RegisterType((*DisableTimeBasedSupplyLimitProposal)(nil), "bitchain.aggregate.v1.DisableTimeBasedSupplyLimitProposal")
}

func init() {
	proto.RegisterFile("bitchain/aggregate/v1/aggregate.proto", fileDescriptor_4eb0564220021b15)
}
