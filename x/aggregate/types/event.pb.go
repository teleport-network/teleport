...
// source: bitchain/aggregate/v1/event.proto
...
type EventIBCAggregate struct {
	Status             Status `protobuf:"varint,1,opt,name=status,proto3,enum=bitchain.aggregate.v1.Status" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("bitchain.aggregate.v1.Status", Status_name, Status_value)
	proto.RegisterType((*EventIBCAggregate)(nil), "bitchain.aggregate.v1.EventIBCAggregate")
	proto.RegisterType((*EventRegisterTokens)(nil), "bitchain.aggregate.v1.EventRegisterTokens")
	proto.RegisterType((*EventEnableTimeBasedSupplyLimit)(nil), "bitchain.aggregate.v1.EventEnableTimeBasedSupplyLimit")
	proto.RegisterType((*EventDisableTimeBasedSupplyLimit)(nil), "bitchain.aggregate.v1.EventDisableTimeBasedSupplyLimit")
}

func init() { proto.RegisterFile("bitchain/aggregate/v1/event.proto", fileDescriptor_b70b4a642b9b3cca) }
