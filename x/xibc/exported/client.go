...
const (
	...
	// TSS is the client type for a TSS client.
	TSS string = "tss"
...
type ClientState interface {
	...
	// Upgrade and Misbehaviour functions
	UpgradeState(sdk.Context, codec.BinaryCodec, sdk.KVStore, ConsensusState) error
