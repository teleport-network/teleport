...
func TestRandomizedGenState(t *testing.T) {
	...
	var xibcGenesis types.GenesisState
	simState.Cdc.MustUnmarshalJSON(simState.GenState[host.ModuleName], &xibcGenesis)

	require.NotNil(t, xibcGenesis.ClientGenesis)
}
