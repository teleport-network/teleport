...
var (
	...
	ErrScChainEqualToDstChain   = sdkerrors.Register(moduleName, 7, "source chain equals to destination chain")
	...
	ErrInvalidDstChain          = sdkerrors.Register(moduleName, 12, "invalid destination chain")
