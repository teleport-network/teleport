...
// client.
type IdentifiedRelayer struct {
	// relayer address on this chain
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	// client identifiers
	Chains []string `protobuf:"bytes,2,rep,name=chains,proto3" json:"chains,omitempty"`
	// relayer addresses on other chains
	Addresses []string `protobuf:"bytes,3,rep,name=addresses,proto3" json:"addresses,omitempty"`
}

func (m *IdentifiedRelayer) Reset()         { *m = IdentifiedRelayer{} }
func (m *IdentifiedRelayer) String() string { return proto.CompactTextString(m) }
func (*IdentifiedRelayer) ProtoMessage()    {}
func (*IdentifiedRelayer) Descriptor() ([]byte, []int) {
	return fileDescriptor_d5d6d555c8c38416, []int{1}
}
func (m *IdentifiedRelayer) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IdentifiedRelayer) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IdentifiedRelayer.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IdentifiedRelayer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IdentifiedRelayer.Merge(m, src)
}
func (m *IdentifiedRelayer) XXX_Size() int {
	return m.Size()
}
func (m *IdentifiedRelayer) XXX_DiscardUnknown() {
	xxx_messageInfo_IdentifiedRelayer.DiscardUnknown(m)
}

var xxx_messageInfo_IdentifiedRelayer proto.InternalMessageInfo

func (m *IdentifiedRelayer) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *IdentifiedRelayer) GetChains() []string {
	if m != nil {
		return m.Chains
	}
	return nil
...
func (m *IdentifiedRelayer) GetAddresses() []string {
	if m != nil {
		return m.Addresses
	}
	return nil
...
type RegisterRelayerProposal struct {
	...
	// the client identifiers for the clients to be updated if the proposal passes
...
func init() {
	...
	proto.RegisterType((*IdentifiedRelayer)(nil), "xibc.core.client.v1.IdentifiedRelayer")
...
var fileDescriptor_d5d6d555c8c38416 = []byte{
	...
	,
}
...
func (m *IdentifiedRelayer) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IdentifiedRelayer) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IdentifiedRelayer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Addresses) > 0 {
		for iNdEx := len(m.Addresses) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintClient(dAtA, i, uint64(len(m.Addresses[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if len(m.Chains) > 0 {
		for iNdEx := len(m.Chains) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintClient(dAtA, i, uint64(len(m.Chains[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *IdentifiedRelayer) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *IdentifiedRelayer) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IdentifiedRelayer: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IdentifiedRelayer: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
