...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customAppTemplate, customAppConfig := servercfg.AppConfig(types.AttoTele)
	...
	rootCmd.AddCommand(
		ethermintclient.ValidateChainID(genutilcli.InitCmd(app.ModuleBasics, app.DefaultNodeHome)),
		genutilcli.CollectGenTxsCmd(banktypes.GenesisBalancesIterator{}, app.DefaultNodeHome),
		genutilcli.MigrateGenesisCmd(),
		genutilcli.GenTxCmd(app.ModuleBasics, encodingConfig.TxConfig, banktypes.GenesisBalancesIterator{}, app.DefaultNodeHome),
		genutilcli.ValidateGenesisCmd(app.ModuleBasics),
		AddGenesisAccountCmd(app.DefaultNodeHome),
		NewRollbackCmd(app.DefaultNodeHome),
		NewRollbackAnyCmd(app.DefaultNodeHome),
