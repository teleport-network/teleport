...
var (
	pattern_Service_GetBlockResults_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"teleport", "base", "tendermint", "v1beta1", "blockresults", "height"}, "", runtime.AssumeColonVerbOpt(true)))
)
